...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexP = /^\/PDL/i;  botRegexTw = /^\/twitch/i; botRegexSb = /^\/sub/; botRegexSh = /^\/shrug/; botRegexWk = /^\/contact list/; botRegexCC = /^\/cc/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/isfl/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://www.daddyleagues.com/isfl/rules");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/isfl/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/isfl/players?name="+rep+"&position=all&team=all");
    ...
    this.res.writeHead(200);
    postMessage("http://www.reddit.com/r/isfl");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://www.daddyleagues.com/isfl/forum/topic/11228");
    this.res.end();
  } 
